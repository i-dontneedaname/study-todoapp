...
import (
	...
	core_http_utils "github.com/i-dontneedaname/study-todoapp/internal/core/transport/http/utils"
)
...
func (h *UsersHTTPHandler) GetUsers(rw http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		responseHandler.ErrorResponse(err, "failed to get query params ('limit' or 'offset') in HTTP handler")
